    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2024, 9, 7, 20, 38, 31, 434, DateTimeKind.Local).AddTicks(7338), 0 },
                    { 2, 2, new DateTime(2024, 9, 7, 20, 38, 31, 434, DateTimeKind.Local).AddTicks(7418), 2 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Delicious chocolate cake", true, "Chocolate Cake", 15.99m },
                    { 2, "Buttery croissant", false, "Croissant", 2.99m },
                    { 3, "Sweet apple pie", true, "Apple Pie", 12.99m }
                });
